...
def read_graphfile():
    distribution_network = nx.read_gml('data/bus37Ex.gml')
    # ****************************************************
    labels = np.load('data/data_1/37_distribution_graphs_labels_1.npz', allow_pickle=True)['arr_0']
    with_without_unserved_samples_indices = np.load('data/data_1/37_with_without_unserved_samples_indices_1.npz', allow_pickle=True)['arr_0']
    degree_PIs = np.load('data/data_1/37_distribution_network_degree_PIs_1.npz', allow_pickle=True)['arr_0']
    betweenness_PIs = np.load('data/data_1/37_distribution_network_betweenness_PIs_1.npz', allow_pickle=True)['arr_0']
    closeness_PIs = np.load('data/data_1/37_distribution_network_closeness_PIs_1.npz', allow_pickle=True)['arr_0']
    # ****************************************************
    edges_failed_list = np.load('data/37_edges_failed.npz', allow_pickle = True)['arr_0']
    node_feature_matrix = np.load('data/37_node_feature_matrix.npz', allow_pickle = True)['arr_0']
    ...
    for i in with_without_unserved_samples_indices:
        ...
        # initial network
        initial_graph = nx.read_gml('data/bus37Ex.gml')
        edge_feature_matrix = np.load('data/37_edge_feature_matrix_one_hot.npz', allow_pickle=True)['arr_0']
    ...
    print("*** 37 Distribution network loading complete ***")
