...
class GraphSampler(torch.utils.data.Dataset):
    ...
    def __init__(self, G_list, degree_PI_list, betweenness_PI_list, closeness_PI_list, features='default', edge_features = 'default', normalize=True, assign_feat='default', max_num_nodes=0, max_num_edges = 460):
